...
const RestaurantDetailTemplate = (restaurant) => `
    ...
    <div id="detail_container">
        <div class="poster-container">
            <img class="restaurant_poster lazyload" data-src="${CONFIG.Get_image + restaurant.pictureId}" alt="${restaurant.name}" tabindex="0" />
...
const createRestaurantItemTemplate = (restaurant) => `
        <div class="card-container" tabindex="0">
            <div class="card-img">
                <img class="resto-img lazyload" data-src="${CONFIG.Get_image + restaurant.pictureId}" alt="picture of restaurant ${restaurant.name}" />
            </div>
            <div class="card-content">
                <div class="title-rating">
                    <a href="/#/detail/${restaurant.id}" class="card-title restaurant__title" id="${restaurant.id} card-title">${restaurant.name}</a>
